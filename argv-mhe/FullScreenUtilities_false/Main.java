...
public final class Main {
    ...
    /** ARG-V: suitable */
	 public static void setWindowCanFullScreen(final Window window, final boolean canFullScreen) {
        ...
        rpc.getRootPane().putClientProperty(Verifier.nondetString(), Boolean.valueOf(canFullScreen));
    }
	...
	public static void main(String[] args) throws Exception {
        ...
        assert (Boolean)((RootPaneContainer)window).getRootPane().getClientProperty(Verifier.nondetString()) == canFullScreen;
	}
}
