...
public class RTEMSThread extends Thread {
   ...
   *     <p>Constructor sets the priority of the thread and initializes the list of mutex for this
   *     thread.
   ...
   *     <p>This function is called when a thread successfully acquires a mutex. Like RTEMS model it
   *     saves this mutex in chain fashion to ensure proper behavior of RTEMS mutex implementation.
   * @param[in] obj<Mutex> It is the mutex that the thread successfully acquired
   */
   ...
   *     <p>If present, it returns the index of mutex obj stored in the thread's mutexOrderList
   * @param[in] obj<Mutex>
   * @param[out] Returns position index of mutex object passed to function if it is present in the
   *     mutexOrderList of this thread or else return -1
   */
